...
class NoConversationFound extends StatelessWidget {
  const NoConversationFound({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Your conversations is empty. Please check back later or refresh to see new conversations.',
